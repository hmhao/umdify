...
var umdify = function(contents, moduleName) {
	...
	moduleName = moduleName || 'returnExports';
	...
	if (requireStatements.paramNames.length > 0) {
		output += '    root.' + moduleName + ' = factory(\n      root.' +requireStatements.paramNames.join(',\n      root.')+ '\n    );\n';
	} else {
		output += '    root.' + moduleName + ' = factory();\n';
	}
	output += '  }\n';
	...
	if (requireStatements.paramNames.length > 0) {
		output += '}(this, function (' + requireStatements.paramNames.join(', ') + ') {';
	} else {
